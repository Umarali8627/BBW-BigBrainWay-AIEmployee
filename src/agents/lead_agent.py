...
from src.tools.lead_tools import collect_leadData
...
SYSTEM_PROMPT = """You are the Lead Qualification Agent for BBW . Use the collect_leadData tool to collect the lead details"""

lead_Agent = create_agent(
    model = model.get_model(),
    tools = [collect_leadData],
